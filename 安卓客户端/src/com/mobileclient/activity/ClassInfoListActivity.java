				...
				handler.post(new Runnable() {
					...
					public void run() {
						...
						adapter = new ClassInfoSimpleAdapter(ClassInfoListActivity.this, list,
	        					...
	        					new String[] { "classNumber","specialName","className","startDate" },
	        					new int[] { R.id.tv_classNumber,R.id.tv_specialName,R.id.tv_className,R.id.tv_startDate,},lv);
	...
	private List<Map<String, Object>> getDatas() {
		...
		try {
			...
			for (int i = 0; i < classInfoList.size(); i++) {
				...
				map.put("startDate", classInfoList.get(i).getStartDate());
				list.add(map);
			}
		} catch (Exception e) { 
