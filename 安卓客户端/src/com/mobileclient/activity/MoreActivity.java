...
public class MoreActivity extends Activity {
	private String[] strs = new String[]{"题目信息","学生选题","留言交流","修改个人信息","关于"};
		...
		list.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
				...
				// TODO Auto-generated method stub
								if(arg2 == 0){
					Intent intent  = new Intent(MoreActivity.this, SubjectListActivity.class);
					startActivity(intent);
				}
				if(arg2 == 1){
					Intent intent  = new Intent(MoreActivity.this, SelectItemListActivity.class);
					startActivity(intent);
				}
				if(arg2 == 2){
