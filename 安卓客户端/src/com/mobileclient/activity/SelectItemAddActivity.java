...
public class SelectItemAddActivity extends Activity {
	// 声明确定添加按钮
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		// 设置当前Activity界面布局
		setContentView(R.layout.selectitem_add); 
		ImageView search = (ImageView) this.findViewById(R.id.search);
		search.setVisibility(View.GONE);
		TextView title = (TextView) this.findViewById(R.id.title);
		title.setText("添加学生选题");
			...
			public void onClick(View v) {
				try {
					...
					if(ET_selectTime.getText().toString().equals("")) {
						Toast.makeText(SelectItemAddActivity.this, "选题时间输入不能为空!", Toast.LENGTH_LONG).show();
					...
					/*调用业务逻辑层上传学生选题信息*/
					SelectItemAddActivity.this.setTitle("正在上传学生选题信息，稍等...");
					String result = selectItemService.AddSelectItem(selectItem);
