				...
				handler.post(new Runnable() {
					...
					public void run() {
						...
						adapter = new StudentSimpleAdapter(StudentListActivity.this, list,
	        					...
	        					new String[] { "studentNumber","classObj","name","sex","birthday","zzmm","photo" },
	        					new int[] { R.id.tv_studentNumber,R.id.tv_classObj,R.id.tv_name,R.id.tv_sex,R.id.tv_birthday,R.id.tv_zzmm,R.id.iv_photo,},lv);
	...
	private List<Map<String, Object>> getDatas() {
		...
		try {
			...
			for (int i = 0; i < studentList.size(); i++) {
				...
				map.put("zzmm", studentList.get(i).getZzmm());
