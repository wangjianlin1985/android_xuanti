...
public class SubjectAddActivity extends Activity {
	// 声明确定添加按钮
			...
			public void onClick(View v) {
				try {
					...
					if(ET_subjectName.getText().toString().equals("")) {
						Toast.makeText(SubjectAddActivity.this, "题目名称输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_content.getText().toString().equals("")) {
						Toast.makeText(SubjectAddActivity.this, "题目内容输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_studentNumber.getText().toString().equals("")) {
						Toast.makeText(SubjectAddActivity.this, "限选人数输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_addTime.getText().toString().equals("")) {
						Toast.makeText(SubjectAddActivity.this, "发布时间输入不能为空!", Toast.LENGTH_LONG).show();
					...
					/*调用业务逻辑层上传题目信息信息*/
					SubjectAddActivity.this.setTitle("正在上传题目信息信息，稍等...");
