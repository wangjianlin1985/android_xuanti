...
public class ClassInfoService {
	...
	public String AddClassInfo(ClassInfo classInfo) {
		...
		params.put("startDate", classInfo.getStartDate().toString());
		params.put("headTeacher", classInfo.getHeadTeacher());
	...
	public List<ClassInfo> QueryClassInfo(ClassInfo queryConditionClassInfo) throws Exception {
		...
		if(queryConditionClassInfo != null) {
			...
			if(queryConditionClassInfo.getStartDate() != null) {
				urlString += "&startDate=" + URLEncoder.encode(queryConditionClassInfo.getStartDate().toString(), "UTF-8");
			}
		}
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				...
				classInfo.setStartDate(Timestamp.valueOf(object.getString("startDate")));
				classInfo.setHeadTeacher(object.getString("headTeacher"));
