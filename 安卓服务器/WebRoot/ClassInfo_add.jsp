...
<table width='100%' cellspacing='1' cellpadding='3' class="tablewidth">
  ...
  <tr>
    <td width=30%>成立日期:</td>
    <td width=70%><input type="text" readonly id="classInfo.startDate"  name="classInfo.startDate" onclick="setDay(this);"/></td>
  </tr>

  <tr>
    <td width=30%>班主任:</td>
    <td width=70%><input id="classInfo.headTeacher" name="classInfo.headTeacher" type="text" size="12" /></td>
  </tr>
