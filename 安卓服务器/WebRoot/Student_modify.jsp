...
<table width='100%' cellspacing='1' cellpadding='3' class="tablewidth">
  ...
  <tr>
    <td width=30%>所在班级:</td>
    <td width=70%>
      <select name="student.classObj.classNumber">
      <%
        for(ClassInfo classInfo:classInfoList) {
          String selected = "";
          if(classInfo.getClassNumber().equals(student.getClassObj().getClassNumber()))
            selected = "selected";
      %>
  ...
  <tr>
    <td width=30%>姓名:</td>
    <td width=70%><input id="student.name" name="student.name" type="text" size="12" value='<%=student.getName() %>'/></td>
  </tr>
  ...
  <tr>
    <td width=30%>政治面貌:</td>
    <td width=70%><input id="student.zzmm" name="student.zzmm" type="text" size="15" value='<%=student.getZzmm() %>'/></td>
  </tr>
