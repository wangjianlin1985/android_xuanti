...
public class StudentAction extends BaseAction {
    ...
    public String AddStudent() {
        ...
        try {
            ClassInfo classObj = classInfoDAO.GetClassInfoByClassNumber(student.getClassObj().getClassNumber());
    ...
    public String QueryStudent() {
        ...
        if(zzmm == null) zzmm = "";
        List<Student> studentList = studentDAO.QueryStudentInfo(studentNumber, classObj, name, birthday, zzmm, currentPage);
        /*计算总的页数和总的记录数*/
        studentDAO.CalculateTotalPageAndRecordNumber(studentNumber, classObj, name, birthday, zzmm);
        /*获取到总的页码数目*/
    ...
    public String QueryStudentOutputToExcel() { 
        ...
        if(birthday == null) birthday = "";
        if(zzmm == null) zzmm = "";
        List<Student> studentList = studentDAO.QueryStudentInfo(studentNumber,classObj,name,birthday,zzmm);
        ExportExcelUtil ex = new ExportExcelUtil();
        String title = "Student信息记录"; 
        String[] headers = { "学号","所在班级","姓名","性别","出生日期","政治面貌","联系电话","个人照片"};
        List<String[]> dataset = new ArrayList<String[]>(); 
        for(int i=0;i<studentList.size();i++) {
        	Student student = studentList.get(i); 
        	dataset.add(new String[]{student.getStudentNumber(),student.getClassObj().getClassName(),
student.getName(),student.getSex(),new SimpleDateFormat("yyyy-MM-dd").format(student.getBirthday()),student.getZzmm(),student.getTelephone(),student.getPhoto()});
        }
        /*
