...
public class StudentDAO {
    ...
    public ArrayList<Student> QueryStudentInfo(String studentNumber,ClassInfo classObj,String name,String birthday,String zzmm,int currentPage) { 
    	Session s = factory.getCurrentSession();
    	String hql = "From Student student where 1=1";
    	if(!studentNumber.equals("")) hql = hql + " and student.studentNumber like '%" + studentNumber + "%'";
    	if(null != classObj && !classObj.getClassNumber().equals("")) hql += " and student.classObj.classNumber='" + classObj.getClassNumber() + "'";
    	if(!name.equals("")) hql = hql + " and student.name like '%" + name + "%'";
    	if(!birthday.equals("")) hql = hql + " and student.birthday like '%" + birthday + "%'";
    	if(!zzmm.equals("")) hql = hql + " and student.zzmm like '%" + zzmm + "%'";
    ...
    @Transactional(propagation=Propagation.NOT_SUPPORTED)
    public ArrayList<Student> QueryStudentInfo(String studentNumber,ClassInfo classObj,String name,String birthday,String zzmm) { 
    	Session s = factory.getCurrentSession();
    	String hql = "From Student student where 1=1";
    	if(!studentNumber.equals("")) hql = hql + " and student.studentNumber like '%" + studentNumber + "%'";
    	if(null != classObj && !classObj.getClassNumber().equals("")) hql += " and student.classObj.classNumber='" + classObj.getClassNumber() + "'";
    ...
    /*计算总的页数和记录数*/
    @Transactional(propagation=Propagation.NOT_SUPPORTED)
    public void CalculateTotalPageAndRecordNumber(String studentNumber,ClassInfo classObj,String name,String birthday,String zzmm) {
        Session s = factory.getCurrentSession();
        String hql = "From Student student where 1=1";
        if(!studentNumber.equals("")) hql = hql + " and student.studentNumber like '%" + studentNumber + "%'";
        if(null != classObj && !classObj.getClassNumber().equals("")) hql += " and student.classObj.classNumber='" + classObj.getClassNumber() + "'";
