...
public class TeacherDAO {
    ...
    public ArrayList<Teacher> QueryTeacherInfo(String teacherNumber,String name,String birthday,String professName,String inDate,int currentPage) { 
    	Session s = factory.getCurrentSession();
    	...
    	if(!professName.equals("")) hql = hql + " and teacher.professName like '%" + professName + "%'";
    ...
    @Transactional(propagation=Propagation.NOT_SUPPORTED)
    public ArrayList<Teacher> QueryTeacherInfo(String teacherNumber,String name,String birthday,String professName,String inDate) { 
    	Session s = factory.getCurrentSession();
    	String hql = "From Teacher teacher where 1=1";
    	if(!teacherNumber.equals("")) hql = hql + " and teacher.teacherNumber like '%" + teacherNumber + "%'";
    	if(!name.equals("")) hql = hql + " and teacher.name like '%" + name + "%'";
    ...
    /*计算总的页数和记录数*/
    @Transactional(propagation=Propagation.NOT_SUPPORTED)
    public void CalculateTotalPageAndRecordNumber(String teacherNumber,String name,String birthday,String professName,String inDate) {
        Session s = factory.getCurrentSession();
        String hql = "From Teacher teacher where 1=1";
        if(!teacherNumber.equals("")) hql = hql + " and teacher.teacherNumber like '%" + teacherNumber + "%'";
        if(!name.equals("")) hql = hql + " and teacher.name like '%" + name + "%'";
