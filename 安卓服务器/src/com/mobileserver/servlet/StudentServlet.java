...
public class StudentServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request,
		...
		if (action.equals("query")) {
			...
			zzmm = zzmm == null ? "" : new String(request.getParameter(
					"zzmm").getBytes("iso-8859-1"), "UTF-8");

			/*调用业务逻辑层执行学生信息查询*/
			List<Student> studentList = studentDAO.QueryStudent(studentNumber,classObj,name,birthday,zzmm);
